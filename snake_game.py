...
class SnakeGame:
    def __init__(self, board_width = 40, board_height = 40, gui = False, timeout = 0, gen = 0):
        self.score = 0
        self.gen = gen
        self.done = False
    ...
    def render(self):
        self.win.clear()
        self.win.border(0)
        self.win.addstr(0, 2, 'Score: ' + str(self.score) + ' / Gen: ' + str(self.gen) + ' ')
